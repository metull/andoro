...
public class Data {
    ...
    public static String[] lastName = {"Смирнова", "Зиновьев", "Зуев", "Зыков", "Иванков", "Иванов", "Игнатов", "Игнатьев", "Ильин", "Исаев", "Исаков", "Кабанов", "Казаков", "Калашников", "Калинин", "Капустин", "Карпов",
    ...
    public static String[] firsName = {"Аарон", "Абрам", "Аваз", "Августин", "Авраам", "Агап", "Агапит", "Агафон", "Адам", "Адриан", "Азамат", "Азат", "Айдар", "Айрат", "Акакий", "Аким", "Алан", "Александр",
    ...
    public static String[] secondName = {"Александрович", "Алексеевич", "Анатольевич", "Андреевич", "Антонович", "Аркадьевич", "Арсеньевич", "Артемович", "Афанасьевич", "Богданович", "Борисович", "Вадимович", "Валентинович",
    ...
    private static final String ab = "абвгдеёжзиклмнопрстуфчшщъыьэюя";
    private static final String email = "qwertyuiopasdfghjklzxcvbnm123456789";
    private static final String phone = "1234567890";
    private static final String code = "1234567890qwertyuiopasdfghjklzxcvbnm123456789";
    private static final String english = "qwertyuiopasdfghjklzxcvbnm";
    private static final String bg = "QWERTYUIOPASDFGHJKLZXCVBNM";
    private static final String theMask = "ADZ";
    ...
    public static String randomSerialNumberPassport(int len) {
    ...
    public static String randomStringLitle(int len) {
        StringBuilder sb = new StringBuilder(len);
        for (int i = 0; i < len; i++)
    ...
    public static String randomEnglStringBig(int len) {
        StringBuilder el = new StringBuilder(len);
        for (int i = 0; i < len; i++)
        el.append(bg.charAt(newRandom.nextInt(bg.length())));
        return el.toString();
    }

    public String theMask(int len) {
        StringBuilder el = new StringBuilder(len);
        for (int i = 0; i < len; i++)
        el.append(theMask.charAt(newRandom.nextInt(theMask.length())));
        return el.toString();
    }
    ...
    public static String randomCode(int len) {
        StringBuilder sb = new StringBuilder(len);
        for (int i = 0; i < len; i++)
            sb.append(code.charAt(newRandom.nextInt(code.length())));
        return sb.toString();
    }
    ...
    public String randomEmail(int len) {
        StringBuilder sb = new StringBuilder(len);
        for (int i = 0; i < len; i++)
            sb.append(email.charAt(newRandom.nextInt(AB.length())));
